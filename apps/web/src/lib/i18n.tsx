...
const en: Record<string, string> = {
  ...
  "home.birthPlaceRequired": "Please select a birth place.",
  ...
  "ring.fire.desc": "Passionate · Spontaneous · Bold",
  "ring.earth.desc": "Grounded · Practical · Steady",
  "ring.air.desc": "Curious · Social · Analytical",
  "ring.water.desc": "Intuitive · Sensitive · Deep",
  "ring.cardinal.desc": "Initiating · Driven · Pioneering",
  "ring.fixed.desc": "Persistent · Loyal · Resolute",
  "ring.mutable.desc": "Adaptable · Flexible · Versatile",
...
const zh: Record<string, string> = {
  ...
  "home.nameRequired": "请填写姓名。",
  "home.birthPlaceRequired": "请选择出生地。",
  ...
  "ring.fixed": "固定",
  "ring.mutable": "变动",
  "ring.fire.desc": "热情 · 直觉 · 行动力",
  "ring.earth.desc": "稳健 · 务实 · 脚踏实地",
  "ring.air.desc": "好奇 · 善于思考 · 社交",
  "ring.water.desc": "敏感 · 直觉深邃 · 情感",
  "ring.cardinal.desc": "主动出击 · 开创新局 · 领导",
  "ring.fixed.desc": "坚持己见 · 专注持久 · 稳定",
  "ring.mutable.desc": "随机应变 · 灵活多变 · 包容",
