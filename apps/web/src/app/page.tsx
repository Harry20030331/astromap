    ...
    <main className="mx-auto flex min-h-full w-full max-w-lg flex-col gap-12 px-4 pb-10 pt-20">
      ...
      >
        <div className="flex min-h-[2.25rem] items-center justify-between gap-2">
          <h2 className="min-w-0 flex-1 truncate text-left text-base font-semibold text-stone-800">
            {t("home.birthData")}
          </h2>
          <button
            type="button"
            className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-stone-300 bg-stone-50 px-2.5 py-1.5 text-xs font-medium text-stone-600 shadow-sm transition-colors hover:border-stone-400 hover:bg-stone-100 hover:text-stone-800"
            aria-label={t("home.pastSessions")}
